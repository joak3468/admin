...
function triggerRef(ref2) {
  triggerRefValue(ref2, 3, false ? ref2.value : void 0);
}
function unref(ref2) {
...
function handleError(err, instance, type, throwInDev = true) {
  ...
  if (instance) {
    ...
    const errorInfo = false ? ErrorTypeStrings$1[type] : `https://vuejs.org/errors/#runtime-${type}`;
    while (cur) {
...
var devtools = __VUE_PROD_DEVTOOLS__ ? devtools$1 : void 0;
var setDevtoolsHook = __VUE_PROD_DEVTOOLS__ ? setDevtoolsHook$1 : NOOP;
var _ssrUtils = {
...
function createCompilerError(code, loc, messages, additionalMessage) {
  const msg = false ? (messages || errorMessages)[code] + (additionalMessage || ``) : `https://vuejs.org/errors/#compiler-${code}`;
...
function walk(node, context, doNotHoistNode = false) {
  ...
  for (let i = 0; i < children.length; i++) {
    ...
    if (child.type === 1 && child.tagType === 0) {
      ...
      if (constantType > 0) {
        if (constantType >= 2) {
          child.codegenNode.patchFlag = -1 + (false ? ` /* HOISTED */` : ``);
  ...
  (node, dir, context) => {
    ...
    return processFor(node, dir, context, (forNode) => {
      ...
      forNode.codegenNode = createVNodeCall(
        ...
        void 0,
        renderExp,
        fragmentFlag + (false ? ` /* ${PatchFlagNames[fragmentFlag]} */` : ``),
        void 0,
        void 0,
        true,
        !isStableFragment,
...
@vue/runtime-dom/dist/runtime-dom.esm-bundler.js:
  (*! #__NO_SIDE_EFFECTS__ *)
*/
//# sourceMappingURL=chunk-AFTYSN32.js.map
